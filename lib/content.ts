...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Web Portfolio",
    description:
      "A personal web portfolio showcasing my skills and projects using Svelte.",
    thumbnail:
      "https://res.cloudinary.com/dxaqtdt72/image/upload/v1771518791/portfolio/lbr5yazjgozh4esbyytu.png",
    tags: ["Freelance", "Web"],
  ...
  },
  {
    ...
    title: "CBI News",
    description:
      'A high-performance multimedia news application built for CBI Digital Media to deliver verified, real-time journalism to a global audience with a focus on the African continent. This digital-first platform serves as a premier destination for credible reporting, engineered to reclaim the African narrative through high-integrity, fact-checked storytelling. The application is built to provide a "clean reading experience," featuring a sleek, intuitive interface that prioritizes readability and user engagement. It leverages a smart personalization system that allows users to tailor their feeds, follow specific categories like Politics or Tech, and receive timely alerts on breaking stories.',
    thumbnail:
      "https://res.cloudinary.com/dxaqtdt72/image/upload/v1771979502/portfolio/o3lorfa6syfutgctr2db.png",
  ...
  },
  {
    ...
    title: "iRunner App",
    description:
      "The iRunner connects you with trusted runners for all your errands. Whether you need groceries, deliveries, or any other task handled, our advanced AI instantly matches you with a reliable runner. \n\nEnjoy real‑time tracking, secure payments, and a seamless experience anytime, anywhere. Get things done faster with fast, secure, and reliable runners.",
    thumbnail:
      "https://res.cloudinary.com/dxaqtdt72/image/upload/v1771978557/portfolio/lmvvqfjoriu7d9xyds2p.png",
  ...
  },
  {
    ...
    title: "Pollproxy",
    description:
      "A Svelte-based polling application for quick and interactive polls.",
  ...
  },
  {
    ...
    title: "Haza Wallet",
    description:
      "A dashboard application for managing payments and financial data.",
  ...
  },
  {
    ...
    title: "Campus Talks",
    description:
      "A platform for hosting and sharing educational talks and events.",
  ...
  },
  {
    ...
    description:
      "A simple guide application demonstrating various ways to center a div.",
    thumbnail:
      "https://placehold.co/800x400/343A40/FFFFFF?text=How+to+Center+a+Div",
  ...
  },
  {
    ...
    description:
      "A lightweight analytics dashboard for monitoring data metrics.",
  ...
  },
  {
    ...
    title: "Reader X",
    description:
      "A frontend beta for a manga reading platform with search and display features.",
  ...
  },
  {
    ...
    title: "Tacky Fruits",
    description:
      "A colorful showcase of fruits with quirky and engaging designs.",
...
export const experiences: Experience[] = [
  {
    ...
    role: "Frontend Developer",
    blurb:
      "Architect and maintain scalable frontend systems using modern frameworks, ensuring optimal performance and seamless user experiences for The Gigs platform.",
    start: "2024-05",
    end: "2025-01",
  },
  {
    ...
    role: "Frontend Developer",
    blurb:
      "Created and maintained a scalable component library using React and TypeScript, significantly reducing development time across multiple projects.",
    start: "2024-02",
    end: "2024-04",
  },
];
